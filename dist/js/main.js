...
var initModel = exports.initModel = {
    ...
    blocmOwnerimgUrl: "../assets/california-2018-small.jpeg",
    homePageSections: [],
    blogEntries: [],
...
function setSection(navElement, section, index) {
